...
const ConfigurationPanel = ({ 
  ...
  const openDeleteModal = (configId) => {
    console.log('🗑️ ConfigurationPanel: Delete button clicked for config:', configId);
    setDeleteTargetId(configId);
    setIsDeleteModalOpen(true);
  };

  const handleConfirmDelete = () => {
    if (deleteTargetId !== null) {
      console.log('🗑️ Calling onConfigDelete with:', deleteTargetId);
      onConfigDelete(deleteTargetId);
    }
