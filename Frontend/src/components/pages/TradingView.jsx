        ...
        const datafeed = {
          ...
          subscribeBars: (symbolInfo, resolution, onRealtimeCallback, subscriberUID, onResetCacheNeededCallback) => {
            ...
            if (resolutionStr === '1' || resolutionStr === '1m') {
              ...
              console.log('⏰ Using 1-minute polling interval (10s)');
